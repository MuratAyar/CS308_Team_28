...
export const deleteCartItem = createAsyncThunk("cart/addToCart", async({userId, productId})=>{
...
export const updateCartItemQty = createAsyncThunk("cart/addToCart", async({userId, productId, quantity})=>{
